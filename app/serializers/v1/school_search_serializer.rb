...
module V1
  class SchoolSearchSerializer < SchoolSerializer
    ...
    attribute :tuition_assistance_type_list do |_person|
      nil
    end
    ...
    belongs_to :pod, id_method_name: :external_identifier do |_school|
      nil
    end

    has_many :school_relationships, serializer: V1::SchoolRelationshipSerializer,
                                    id_method_name: :external_identifier do |_school|
      nil
    end

    has_many :people, id_method_name: :external_identifier do |_school|
      nil
    end

    has_many :sister_schools, id_method_name: :external_identifier do |_school|
      nil
    end

    has_one :address, serializer: V1::AddressSerializer, id_method_name: :external_identifier do |_school|
      nil
    end
