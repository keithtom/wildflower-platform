class V1::Workflow::StepSerializer < ApplicationSerializer
  ...
  attribute :min_worktime do |step|
    distance_of_time_in_words(step.definition.min_worktime.minutes) if step.definition&.min_worktime
  end

  attribute :max_worktime do |step|
    distance_of_time_in_words(step.definition.max_worktime.minutes) if step.definition&.max_worktime
  end
