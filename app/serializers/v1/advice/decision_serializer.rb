class V1::Advice::DecisionSerializer < ApplicationSerializer
  ...
  belongs_to :creator, serializer: V1::PersonSerializer, id_method_name: :external_identifier

  has_many :stakeholders, serializer: V1::Advice::StakeholderSerializer, id_method_name: :external_identifier

  has_many :documents, serializer: V1::DocumentSerializer, id_method_name: :external_identifier
